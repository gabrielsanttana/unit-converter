...
public class Helper extends JPanel {
	...
	public Helper() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Unit Converter", TitledBorder.LEADING,
		...
		picLabel.setIcon(new ImageIcon(this.getClass().getResource("/resources/unicamp-logo.png")));
