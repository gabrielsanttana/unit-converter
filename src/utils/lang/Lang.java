...
public abstract class Lang {
  ...
  public static final String[] pt_br = new String[] {"Portuguese", "Português"};
  public static final String[] en_us = new String[] {"English", "Inglês"};
  public static final String[] language = new String[] {"Language", "Linguagem"};
  ...
  public static void setLanguage(ELang selectedLanguage) {
